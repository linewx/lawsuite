 ...
 */
public class FirstCivilConciliationInstrumentParser implements InstrumentParser {
    ...
    private Instrument parseContext(ParseContext context) {
        ...
        List<String> firstConciliationResults = results.get("firstConciliation");
        Boolean firstConciliation = false;
        if (firstConciliationResults != null && !firstConciliationResults.isEmpty()) {
            firstConciliation = true;
        }
